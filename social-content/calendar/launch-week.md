...
- URL UTM: https://www.calcolich.ch/de/quellensteuer-rechner-schweiz?utm_source=linkedin&utm_medium=organic_social&utm_campaign=quellensteuer_2026&utm_content=launch_week_1
- Obiettivo: Traffico qualificato e apertura della guida collegata
- Metrica: CTR sul link e guide open
- Stato: bozza
- CTA: Quellensteuer kostenlos berechnen
- Visuale o scena: LinkedIn-Visual con calcolatore in evidenza e tre blocchi: Bruttolohn, Kanton, Familienstand.
...
- URL UTM: https://www.calcolich.ch/de/praemienverbilligung-rechner-schweiz?utm_source=facebook&utm_medium=organic_social&utm_campaign=praemienverbilligung_2026&utm_content=launch_week_2
- Obiettivo: Haushaltsnahe Reichweite und Linkklicks
- Metrica: Linkklicks und Kommentare
- Stato: bozza
- CTA: Prämienverbilligung berechnen
- Visuale o scena: Budget-Tisch mit Krankenkassenrechnung, Kalender und Laptop.
- Testo completo: Die Krankenkassenprämie belastet das Budget schnell. Der Rechner hilft dir, Einkommen, Kanton und Haushaltskontext als Ausgangspunkt zu ordnen. Das Ergebnis ersetzt keine offizielle kantonale Prüfung, macht den nächsten Schritt aber klarer. Wenn du wissen willst, welche Unterlagen typischerweise gebraucht werden, lies danach die kurze Anleitung.
...
- URL UTM: https://www.calcolich.ch/de/brutto-netto-rechner-schweiz?utm_source=linkedin&utm_medium=organic_social&utm_campaign=brutto_netto_2026&utm_content=launch_week_3
- Obiettivo: Vergleich von Lohnangeboten und Budgetplanung
- Metrica: CTR auf den Rechner
- Stato: bozza
- CTA: Brutto und Netto vergleichen
- Visuale o scena: Saubere Tabelle mit drei Spalten: Brutto, Abzüge, Netto.
...
- URL UTM: https://www.calcolich.ch/de/ueberstundenrechner-schweiz?utm_source=tiktok&utm_medium=organic_social&utm_campaign=ueberstunden_2026&utm_content=launch_week_4
- Obiettivo: Video-Views und Calculator-Starts
- Metrica: 3-Sekunden-Views und Klicks
- Stato: bozza
- CTA: Überstunden berechnen
- Visuale o scena: Zeitkarte, Stoppuhr und Rechner im schnellen Schnitt.
- Hook: Überstunden? Rechne nicht nach Gefühl.
- Scene: Szene 1: Zeiterfassung oder Stempelkarte. | Szene 2: Rechner öffnen. | Szene 3: Stunden und Lohn sichtbar machen. | Szene 4: Hinweis auf Arbeitszeit, Pausen und Monatslohn. | Szene 5: CTA einblenden.
- Testo in sovrimpressione: Überstunden | Stunden zählen | Lohn sauber prüfen | Nicht schätzen | Jetzt berechnen
- Script: Überstunden wirken oft klein, summieren sich aber schnell. Öffne den Rechner, gib deine Stunden ein und prüfe den Wert zusammen mit dem Lohnkontext. Wenn dein Fall von Arbeitszeit, Pausen oder Monatslohn abhängt, hilft die Folgeanalyse mehr als ein Bauchgefühl. Am Ende zählt nicht nur die Zahl, sondern auch die Frage, wie du sie sauber einordnest.
...
- URL UTM: https://www.calcolich.ch/de/ferienrechner-schweiz?utm_source=instagram&utm_medium=organic_social&utm_campaign=ferien_2026&utm_content=launch_week_5
- Obiettivo: Saves, Carousel-Completion und Linkklicks
- Metrica: Saves und Profilklicks
- Stato: bozza
- CTA: Ferien berechnen
- Visuale o scena: Carousel mit Kalender, Teilzeit-Hinweis und Jahresanspruch.
- Caption: Ferienanspruch wirkt simpel, bis Teilzeit, Jahresarbeit oder unterschiedliche Wochenmodelle dazukommen. Der Rechner hilft, den Jahresanspruch sauber zu lesen, bevor du planst oder anpasst. Die Anleitung erklärt den Schweizer Kontext ohne unnötige Formeln.
...
- URL UTM: https://www.calcolich.ch/de/familienzulagen-rechner-schweiz?utm_source=facebook&utm_medium=organic_social&utm_campaign=familienzulagen_2026&utm_content=launch_week_6
- Obiettivo: Relevanz für Familien und Linkklicks
- Metrica: Linkklicks und Lead-Starts
- Stato: bozza
- CTA: Familienzulagen berechnen
- Visuale o scena: Familienfoto mit Kalender und kurzer Checkliste auf dem Tisch.
- Testo completo: Familienzulagen sind kein Detail, wenn man das Monatsbudget plant. Der Rechner hilft, den Anspruch und den Kontext einfacher einzuordnen, bevor du Unterlagen prüfst oder kantonale Unterschiede vergleichst. Wenn Kinder- oder Ausbildungszulagen für dich relevant sind, starte hier und lies danach die kurze Anleitung.
...
- URL UTM: https://www.calcolich.ch/de/hypotheken-tragbarkeit-rechner-schweiz?utm_source=youtube&utm_medium=organic_social&utm_campaign=hypotheken_2026&utm_content=launch_week_7
- Obiettivo: Watch Time und Klicks zum Tragbarkeitsrechner
- Metrica: Durchschnittliche Wiedergabedauer und Linkklicks
- Stato: bozza
- CTA: Tragbarkeit prüfen
- Visuale o scena: Haus, Rate und Tragbarkeit in einer ruhigen, klaren Szene.
- Hook: Tragbarkeit? Erst rechnen, dann reden.
- Scene: Szene 1: Haus oder Wohnung als Einstieg. | Szene 2: Tragbarkeit mit Einkommen verbinden. | Szene 3: Rechner auf dem Bildschirm zeigen. | Szene 4: Hinweis auf Budget und Bankgespräch. | Szene 5: CTA mit der nächsten Aktion.
- Testo in sovrimpressione: Tragbarkeit | Einkommen prüfen | Budget klären | Erst rechnen | Dann sprechen
- Script: Bei einer Hypothek entscheidet nicht nur die Monatsrate. Wichtig ist, ob Tragbarkeit, Einkommen und Belastung zusammenpassen. Der Rechner gibt dir eine erste Orientierung, bevor du mit Bank, Berater oder Partner sprichst. Wenn du wissen willst, wie stark deine Zahlen wirklich sind, starte hier und lies die Anleitung danach.
- Descrizione: Kurzer Überblick, wie Tragbarkeit vor dem nächsten Finanzierungs-Schritt gelesen wird.
