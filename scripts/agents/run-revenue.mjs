...
await writeFile(join(STATE_DIR, 'revenue.json'), JSON.stringify({ stamp: result.stamp, revenue: result.revenue }, null, 2), 'utf8');
console.log(result.revenue.report.markdown);
