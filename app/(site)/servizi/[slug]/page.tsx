...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://www.calcolich.ch/servizi/${page.slug}` },
  };
}
  ...
  const schemas = [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Servizi", item: "https://www.calcolich.ch/servizi-ai-seo" },
        { "@type": "ListItem", position: 3, name: page.shortTitle, item: `https://www.calcolich.ch/servizi/${page.slug}` },
      ],
    },
  ];
