...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.calcolich.ch/guide/${guide.slug}`,
    },
  };
}
...
export default async function GuidePage({ params }: Props) {
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: `https://www.calcolich.ch/guide/${guide.slug}`,
  };
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: "Calcolich",
        item: "https://www.calcolich.ch",
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "Guide",
        item: "https://www.calcolich.ch/guide",
      },
      {
        "@type": "ListItem",
        position: 3,
        name: guide.title,
        item: `https://www.calcolich.ch/guide/${guide.slug}`,
      },
    ],
  };
