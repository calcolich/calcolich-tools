...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.calcolich.ch",
  },
};
    ...
    <main className="min-h-screen bg-[#f6f8fb] text-gray-950">
      <section className="border-b border-gray-200 bg-white px-5 py-6 md:px-10">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4">
          ...
          <nav className="flex flex-wrap items-center justify-end gap-1 text-sm font-semibold text-gray-600">
            <Link href="/de" className="rounded-full px-2 py-2 hover:bg-gray-100">DE</Link>
            <Link href="/it" className="rounded-full px-2 py-2 hover:bg-gray-100">IT</Link>
            <Link href="/en" className="rounded-full px-2 py-2 hover:bg-gray-100">EN</Link>
            <Link href="/fr" className="rounded-full px-2 py-2 hover:bg-gray-100">FR</Link>
